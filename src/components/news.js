            ...
            <div class="content pt-[50px]">
                ...
                <div class="content-top grid grid-cols-4 pt-[50px]">
                    ...
                    <div
                        ...
                        <p class="pt-[10px] text-sm text-slate-500">ĐONG HO NAM</p>
                        <h4 class="text-base"><a href="" class="no-underline text-stone-900 hover:text-amber-700">ĐỒNG HỒ
                                TISSOT T063.907.11.058.00 NAM TỰ ĐỘNG DÂY INOX</a></h4>
                        <!-- <del>5,600,000đ</del> -->
                        <div class="text">
                    ...
                    <div
                        ...
                        <p class="pt-[10px] text-sm text-slate-500">ĐONG HO NAM</p>
                        <h4 class="text-base"><a href="" class="no-underline text-stone-900 hover:text-amber-700">ĐỒNG HỒ
                                SEIKO SGEG99P1 NAM PIN DÂY DA</a></h4>
                        <!-- <del>5,600,000đ</del> -->
                        <div class="text">
                ...
                <div class="content-top-new grid grid-cols-4 pt-[30px]">
                    <div
                        ...
                        <p class="pt-[10px] text-sm text-slate-500">ĐONG HO NAM</p>
                        <h4 class="text-base"><a href="" class="no-underline text-stone-900 hover:text-amber-700">ĐỒNG HỒ
                                ORIENT FSTAA002W0 NAM PIN DÂY DA</a></h4>
                        <!-- <del>5,600,000đ</del> -->
                        <div class="text">
                            <del>3,042,000đ</del>
                    ...
                    <div
                        ...
                        <p class="pt-[10px] text-sm text-slate-500">ĐONG HO NAM</p>
                        <h4 class="text-base"><a href="" class="no-underline text-stone-900 hover:text-amber-700">ĐỒNG HỒ
                                OLYM PIANUS OP99141-71AGSK TRẮNG NAM TỰ ĐỘNG DÂY..</a></h4>
                        <!-- <del>5,600,000đ</del> -->
                        <div class="text">
                            <del>7,680,000đ</del>
                    ...
                    <div
                        ...
                        <p class="pt-[10px] text-sm text-slate-500">ĐONG HO NAM</p>
                        <h4 class="text-base"><a href="" class="no-underline text-stone-900 hover:text-amber-700">ĐỒNG HỒ
                                CASIO GA-110GB-1ADR NAM PIN DÂY NHỰA</a></h4>
                        <!-- <del>5,600,000đ</del> -->
                        <div class="text">
                            <!-- <del>7,680,000đ</del> -->
                            <!-- <strong>6,912,000 đ</strong> -->
                    ...
                    <div
                        ...
                        <p class="pt-[10px] text-sm text-slate-500">ĐONG HO NAM</p>
                        <h4 class="text-base"><a href="" class="no-underline text-stone-900 hover:text-amber-700">ĐỒNG HỒ
                                CASIO MTP-1374L-1AVDF NAM PIN DÂY DA</a></h4>
                        <!-- <del>5,600,000đ</del> -->
                        <div class="text">
                            <del>1,863,000đ</del>
